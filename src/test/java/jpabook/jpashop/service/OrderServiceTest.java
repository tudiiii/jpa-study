...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        //given
        Member member = createMember("member1", new Address("서울", "경기", "123-13"));
        Item book = createBook("book name", 10000, 10);
        ...
        Assert.assertEquals("주문한 상품 수만큼 재고가 줄어야 한다.", 8, book.getStockQuantity());
    ...
    public void 상품주문_재고수량초과() throws Exception {
        //given
        Member member = createMember("member1", new Address("서울", "경기", "123-13"));
        Item item = createBook("book name", 10000, 10);
